...
elseif length(AoS0unique)>1 && length(AoA0unique)==1 
   ...
   attMode = 'both';
   angle0 = AoA0;
   anglesS = round(BAL0.AoS*20)/20; % angle(s) of sideslip of measurements
   anglesA = round(BAL0.AoA*20)/20; % angle(s) of sideslip of measurements
...
%     end
    ...
    B1_0 = griddata(round(anglesA*20)/20,round(anglesS*20)/20,BAL0tot(:,idxB.zero.B1,1),round(BAL.AoA*20)/20,round(BAL.AoS*20)/20);
    B2_0 = griddata(round(anglesA*20)/20,round(anglesS*20)/20,BAL0tot(:,idxB.zero.B2,1),round(BAL.AoA*20)/20,round(BAL.AoS*20)/20);
    B3_0 = griddata(round(anglesA*20)/20,round(anglesS*20)/20,BAL0tot(:,idxB.zero.B3,1),round(BAL.AoA*20)/20,round(BAL.AoS*20)/20);
    B4_0 = griddata(round(anglesA*20)/20,round(anglesS*20)/20,BAL0tot(:,idxB.zero.B4,1),round(BAL.AoA*20)/20,round(BAL.AoS*20)/20);
    B5_0 = griddata(round(anglesA*20)/20,round(anglesS*20)/20,BAL0tot(:,idxB.zero.B5,1),round(BAL.AoA*20)/20,round(BAL.AoS*20)/20);
    B6_0 = griddata(round(anglesA*20)/20,round(anglesS*20)/20,BAL0tot(:,idxB.zero.B6,1),round(BAL.AoA*20)/20,round(BAL.AoS*20)/20);
...
%         end
    elseif strcmpi(attMode,'both')
        error('AoA and AoS varied in zero run -> not implemented yet.')  
    end
end
